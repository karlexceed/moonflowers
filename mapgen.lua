...
if mg_name == "v6" then
	...
	minetest.register_decoration({
		...
		spawn_by = {"default:tree", "default:pine_tree", "default:jungletree"},
		num_spawn_by = 1,
	})
	...
	minetest.register_decoration({
		...
		y_min = 20,
		decoration = "moonflowers:moonflower",
		spawn_by = {"default:tree", "default:aspen_tree", "default:acacia_tree", "default:pine_tree", "default:jungletree"},
		num_spawn_by = 1,
	})
